...
.ca-no-exec-title { font-size: 0.9rem; font-weight: 700; color: #374151; margin-bottom: 5px; }
.ca-no-exec-sub   { font-size: 0.78rem; color: #94a3b8; line-height: 1.5; }
...
.ca-exec-name { font-size: 1rem; font-weight: 800; color: #0d0f1c; letter-spacing: -0.02em; margin-bottom: 3px; }
.ca-exec-sub  { font-size: 0.73rem; color: #94a3b8; font-weight: 500; }
...
.ca-exec-stat:not(:last-child) { border-right: 1px solid #f4f5fb; }
.ca-exec-stat-val { font-size: 1.1rem; font-weight: 900; color: #0d0f1c; letter-spacing: -0.03em; }
.ca-exec-stat-lbl { font-size: 0.6rem; text-transform: uppercase; letter-spacing: 0.09em; color: #94a3b8; font-weight: 700; margin-top: 2px; }
...
.ca-history-row:hover { background: #f5f3ff; }
.ca-history-date { font-size: 0.73rem; color: #94a3b8; font-weight: 500; }
.ca-history-score { font-size: 0.8rem; font-weight: 800; font-family: 'SF Mono', 'Consolas', monospace; }

/* Score Preview */
.ca-score-card { padding: 24px; }
.ca-score-head {
    display: flex;
    align-items: center;
    justify-content: space-between;
...
.ca-tile-pos { background: #ecfdf5; border-color: #a7f3d0; }
.ca-tile-neg { background: #fff1f2; border-color: #fecdd3; }
.ca-tile-rec { background: #eff6ff; border-color: #bfdbfe; }
.ca-tile-val { font-size: 1.35rem; font-weight: 900; letter-spacing: -0.04em; line-height: 1; }
.ca-tile-pos .ca-tile-val { color: #059669; }
.ca-tile-neg .ca-tile-val { color: #e11d48; }
.ca-tile-rec .ca-tile-val { color: #2563eb; }
.ca-tile-lbl { font-size: 0.6rem; text-transform: uppercase; letter-spacing: 0.1em; color: #94a3b8; font-weight: 700; margin-top: 5px; }
...
.ca-kpi-result.pass { background: #ecfdf5; color: #059669; border: 1.5px solid #a7f3d0; }
.ca-kpi-result.fail { background: #fff1f2; color: #e11d48; border: 1.5px solid #fecdd3; }
...
<div class="col-xl-8">
    ...
    <div class="ca-step-card">
        <div class="ca-step-head">
            <div class="ca-step-num" style="background:linear-gradient(135deg,#f43f5e,#e11d48);">04</div>
            <div class="ca-step-info">
    ...
    <div class="ca-step-card">
        <div class="ca-step-head">
            <div class="ca-step-num" style="background:linear-gradient(135deg,#64748b,#475569);">05</div>
            <div class="ca-step-info">
        ...
        .then(data => {
            ...
            if (!data.recent_audits || data.recent_audits.length === 0) {
                ...
                data.recent_audits.forEach(a => {
                    ...
                    const color = score >= 0 ? '#059669' : '#e11d48';
                    list.innerHTML += `
                    <div class="ca-history-row">
                        <span class="ca-history-date">${a.audit_date}</span>
                        <span class="ca-history-score" style="color:${color};">${score>=0?'+':''}${score}</span>
                    </div>`;
                });
            }
            schedulePreview();

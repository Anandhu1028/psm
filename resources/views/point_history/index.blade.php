...
@section('breadcrumb')
<ol class="breadcrumb"><li class="breadcrumb-item active">Point History</li></ol>
@endsection
...
.btn-ph-export:active { transform: translateY(0); }
...
.ph-stat-credits::after  { background: #10b981; }
.ph-stat-debits::after   { background: #f43f5e; }
.ph-stat-txns::after     { background: #6366f1; }
...
.ph-stat-credits .ph-stat-icon-wrap { background: #ecfdf5; color: #10b981; }
.ph-stat-debits  .ph-stat-icon-wrap { background: #fff1f2; color: #f43f5e; }
.ph-stat-txns    .ph-stat-icon-wrap { background: #eef2ff; color: #6366f1; }
...
.ph-stat-credits .ph-stat-value { color: #059669; }
.ph-stat-debits  .ph-stat-value { color: #e11d48; }
.ph-stat-txns    .ph-stat-value { color: #3730a3; }
...
.ph-stat-foot i { font-size: 0.65rem; }
...
.ph-pills-clear:hover { background: #fff1f2; color: #e11d48; text-decoration: none; }
...
.ph-search-wrap i { color: #c4b5fd; font-size: 0.82rem; }
.ph-search-input {
    border: none; outline: none; background: transparent;
    font-size: 0.82rem; color: #334155;
    width: 100%; font-family: inherit;
}
.ph-search-input::placeholder { color: #c4b5fd; }
...
.ph-tbl thead th:first-child { padding-left: 28px; }
.ph-tbl thead th:last-child  { padding-right: 28px; }
.ph-tbl tbody tr {
    border-bottom: 1px solid #f7f8fc;
    transition: background 0.15s ease;
}
.ph-tbl tbody tr:last-child { border-bottom: none; }
.ph-tbl tbody tr:hover { background: #fafaff; }
.ph-tbl tbody td {
    padding: 15px 16px;
    vertical-align: middle;
    color: #374151;
}
.ph-tbl tbody td:first-child { padding-left: 28px; }
.ph-tbl tbody td:last-child  { padding-right: 28px; }

/* Row: Executive */
.ph-exec { display: flex; align-items: center; gap: 11px; }
.ph-avatar {
...
.ph-exec-name:hover { color: #4f46e5; text-decoration: none; }
.ph-exec-id {
    font-size: 0.65rem;
    color: #b0b8d1;
    font-weight: 500;
...
.ph-date i { color: #c4b5fd; }

/* Row: Company */
.ph-company { font-size: 0.83rem; font-weight: 600; color: #2d3748; }
.ph-zone {
    display: inline-flex;
    align-items: center;
    gap: 4px;
...
.ph-chip-positive  { background: #ecfdf5; color: #059669; border: 1.5px solid #a7f3d0; }
.ph-chip-negative  { background: #fff1f2; color: #e11d48; border: 1.5px solid #fecdd3; }
.ph-chip-recovery  { background: #eff6ff; color: #2563eb; border: 1.5px solid #bfdbfe; }
.ph-chip-kpi       { background: #fffbeb; color: #d97706; border: 1.5px solid #fde68a; }
.ph-chip-neutral   { background: #f8f9fc; color: #64748b; border: 1.5px solid #e2e8f0; }
.ph-chip-credit    { background: #ecfdf5; color: #059669; border: 1.5px solid #a7f3d0; }
.ph-chip-debit     { background: #fff1f2; color: #e11d48; border: 1.5px solid #fecdd3; }
...
/* Empty State */
.ph-empty { text-align: center; padding: 80px 24px; }
.ph-empty-blob {
...
.ph-empty-h { font-size: 1rem; font-weight: 800; color: #1e1f2e; margin-bottom: 6px; }
.ph-empty-p { font-size: 0.82rem; color: #94a3b8; }
...
.ph-modal-head-left { display: flex; align-items: center; gap: 13px; }
.ph-modal-illo {
...
.ph-modal-title { font-size: 1.02rem; font-weight: 800; color: #0d0f1c; letter-spacing: -0.02em; }
.ph-modal-sub   { font-size: 0.73rem; color: #94a3b8; margin-top: 1px; }
.ph-modal-close-btn {
    width: 34px; height: 34px;
    border-radius: 10px;
    background: #fff;
...
.ph-modal-close-btn:hover { background: #fee2e6; border-color: #fca5a5; color: #e11d48; }
.ph-modal-body { padding: 28px; }
.ph-modal-section { margin-bottom: 24px; }
.ph-modal-section:last-child { margin-bottom: 0; }
...
.ph-modal-foot-right { display: flex; gap: 8px; }
...
.btn-ph-modal-reset {
    ...
    border-radius: 11px; color: #64748b;
    font-size: 0.82rem; font-weight: 600;
    cursor: pointer; text-decoration: none;
    transition: all 0.18s;
}
.btn-ph-modal-reset:hover { border-color: #f43f5e; color: #e11d48; background: #fff1f2; text-decoration: none; }
.btn-ph-modal-cancel {
    display: inline-flex; align-items: center; gap: 7px;
    height: 40px; padding: 0 18px;
    background: #fff; border: 1.5px solid #e8eaf2;
...
.btn-ph-modal-cancel:hover { background: #f8f9fc; border-color: #cbd5e1; }
.btn-ph-modal-apply {
...
.btn-ph-modal-apply:hover { background: #4f46e5; box-shadow: 0 6px 18px rgba(99,102,241,0.4); transform: translateY(-1px); }

@media (max-width: 1024px) { .ph-stats-row { grid-template-columns: repeat(2, 1fr); } }
@media (max-width: 640px) {
    .ph-stats-row { grid-template-columns: 1fr; gap: 12px; }
    .ph-stat-value { font-size: 1.75rem; }
    .ph-modal { border-radius: 18px; }
    .ph-modal-body { padding: 20px; }
    .ph-modal-head { padding: 18px 20px 16px; }
    .ph-modal-foot { padding: 14px 20px 18px; flex-direction: column; }
    .ph-modal-foot-right { width: 100%; }
    .btn-ph-modal-apply { width: 100%; justify-content: center; }
}
</style>
@endpush
...
<div class="ph-header">
    ...
    <div class="ph-header-actions">
        ...
        <a href="{{ route('reports.export', array_merge(request()->all(), ['type'=>'violation'])) }}" class="btn-ph-export">
    ...
    <div class="ph-table-scroll">
        <table class="ph-tbl" id="phTable">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <span class="ph-date"><i class="fa-regular fa-calendar"></i>{{ $tx->audit_date->format('d M Y') }}</span>
                    </td>
                    ...
                    <td>
                        <div class="ph-exec">
                            ...
                            <div>
                                <a href="{{ route('executives.show', $tx->executive_id) }}" class="ph-exec-name">{{ $tx->executive->name }}</a>
                    ...
                    <td>
                        ...
                        <div class="ph-zone"><i class="fa-solid fa-location-dot"></i>{{ $tx->executive->zone->name ?? '—' }}</div>
                    </td>
                    ...
                    <td style="text-align:center;">
                        <span class="ph-chip {{ $tx->type === 'credit' ? 'ph-chip-credit' : 'ph-chip-debit' }}">
                            <i class="fa-solid {{ $tx->type === 'credit' ? 'fa-arrow-up' : 'fa-arrow-down' }}" style="font-size:0.6rem;"></i>
                            {{ ucfirst($tx->type) }}
                        </span>
                    </td>
    ...
    <div class="ph-modal" role="dialog" aria-modal="true" aria-labelledby="phFilterTitle">
        ...
        <div class="ph-modal-foot">
            ...
            <div class="ph-modal-foot-right">
                ...
                <button type="submit" class="btn-ph-modal-apply"><i class="fa-solid fa-filter"></i> Apply Filters</button>
            </div>
        </div>
        </form>
